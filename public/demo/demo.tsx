...
export default function Home() {
    ...
    const options = ["day", "night", "dusk", "sunset"];
            ...
            <div className="main-content">
                <div className="window">
                    ...
                    <div className="illustration">
                        <div className={`time ${activeOption}`}>
                            <div className="sky">
                            ...
                            <div className="trees">
                                <svg width="210px" viewBox="0 0 85.04 41.1">
                                    ...
                                    <g opacity="0.2">
                                        <path fill="#FFFFFF" d="M72.955,21.309c0-8.892,1.883-18.68,4.332-20.333c-0.354-0.16-0.715-0.247-1.082-0.247     c-4.188,0-7.582,10.83-7.582,20.579c0,4.187,3.395,7.581,7.582,7.581c0.369,0,0.729-0.035,1.082-0.086     C74.84,28.277,72.955,25.127,72.955,21.309z"></path><path fill="#FFFFFF" d="M66.457,24.933c0-7.106,1.383-14.901,3.191-16.359c-0.334-0.157-0.676-0.263-1.025-0.263     c-3.588,0-6.5,8.749-6.5,16.622c0,3.382,2.912,6.125,6.5,6.125c0.35,0,0.691-0.034,1.025-0.084     C67.84,30.508,66.457,27.984,66.457,24.933z"></path>
                                    </g>
                                    <g>
