...
export default function Tuoi2023() {
    ...
    return (
        <>
            <div id="card">
                <div id="card-inside">
                <div className="wrap wishesFont">
                    <center style={{ fontSize: 18 }}>
                    <p>Xin chào bé Tươi!!!</p>
                    <p>
                        Nghe thiên hạ đồn: hôm nay là một ngày đặc biệt, là ngày mà một
                        thiên thần xinh đẹp đã có mặt trên thế giới này!🤣😶‍🌫️
                    </p>
                    <p>
                        Do dốt văn nên không biết chúc gì ngoài những điều tốt đẹp nhất,
                        chúc Tươi tuổi mới xinh tươi, yêu đời, luôn tràn đầy năng lượng(chứ
                        thi thoảng thấy héo quá).{" "}
                    </p>
                    <p>thành công trong công việc và đạt được những dự định lớn!</p>
                    <p>đặc biệt luôn giữ nụ cười trên môi nhé😉</p>
                    </center>
                    <p className="signed">by 🤪</p>
                </div>
                </div>
                <div id="card-front">
                <div className="wrap">
                    ...
                    <Image width={100} height={100}
                        src="/image/2023/no2.png"
                        alt="hihi" className="w-full"
                    ...
                    >
                        <Image width={100} height={100} alt="" src="/image/banner/banner.png " className="bannar w-full" />
                    </div>
                    </div>
                    <h1 style={{ marginTop: "20%" }}>Bé Tươi</h1>
                ...
                <audio src="/audio.mp3" id="myAudio" />
                <button id="open" onClick={playMyAudio} style={{ fontSize: 20 }}>
                    Open &gt;&gt;
                </button>
                <button id="close" onClick={pauseMyAudio}>
                    &lt;&lt;
                </button>
                <div className="card-front_inside">
                    ...
                    <div
                        className="img"
                        style={{ backgroundImage: 'url("/image/2023/no1.png")' }}
                    />
                    </div>
                    <div className="shadow" />
                </div>
                </div>
                <canvas className="canvas " width="100% " height="100% " />
                <script async src="js/index.js"></script>
                <script async src="js/color_bg_effect.js"></script>
                <script async src="js/render.js"></script>
                <canvas
                className="fireworks"
                style={{
                    position: "fixed",
